...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >=6){?> style="color: red;" <?php }
    elseif ($json_data['features'][$n]['properties']['mag'] <=4){ ?> style="color:RGBA(0,0,0,0);" <?php }
    elseif ($json_data['features'][$n]['properties']['mag'] >=4.5){ ?> style="color:RGB(20,221,136)" <?php }
    elseif ($json_data['features'][$n]['properties']['mag'] >=5){ ?> style="color:RGB(151,21,40);" <?php }
    elseif ($json_data['features'][$n]['properties']['mag'] >=5.5){ ?> style="color:RGB(224,121,136)" <?php }
    else{ ?> style="color:white);" <?php };?>>
